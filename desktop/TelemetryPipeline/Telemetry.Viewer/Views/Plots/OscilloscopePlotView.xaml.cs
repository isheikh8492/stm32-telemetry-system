...
namespace Telemetry.Viewer.Views.Plots
{
    ...
    public partial class OscilloscopePlotView : UserControl, IPlotView
    {
        ...
        // to the IPlotView display name. The label itself comes from the
        // settings record — the view doesn't know about other plot types.
        ...
        // IPlotView.AttachContextMenu — invoked by ViewportSession on register.
